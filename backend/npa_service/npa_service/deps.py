...
from npa_service.application.ports import ChangeSummarizer, NpaSource
...
from npa_service.infrastructure.llm import OpenRouterChangeSummarizer
...
from npa_service.infrastructure.simulation import SimulationChangeSummarizer, SimulationSource
...
def get_npa_registration() -> NpaRegistration:
    return NpaRegistration(get_npa_repo(), get_npa_source())
