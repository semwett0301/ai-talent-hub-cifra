...
docker-compose.dev.yml    # optional overlay: frontend_dev (Vite HMR on :5173, source bind-mounted, /api proxied to nginx)
...
# + Vite dev server with hot reload on http://localhost:5173 (edits in frontend/ reload live)
